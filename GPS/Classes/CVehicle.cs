    ...
    public class CVehicle
    {
        ...
        public void DrawVehicle()
        {
            ...
            if (mf.curve.isBtnCurveOn && !mf.ct.isContourBtnOn)
            {
                ...
                else if (mf.curve.howManyPathsAway > 0) mf.font.DrawTextVehicle(0, wheelbase + 1, mf.curve.howManyPathsAway.ToString() + "R", 1.4);
                else mf.font.DrawTextVehicle(0, wheelbase + 1, mf.curve.howManyPathsAway.ToString() + "L", 1.4);
            }
            else if (mf.ABLine.isBtnABLineOn && !mf.ct.isContourBtnOn)
            {
                ...
                if (mf.ABLine.howManyPathsAway == 0)
                    ...
                    mf.font.DrawTextVehicle(0, wheelbase + 1, mf.ABLine.howManyPathsAway.ToString() + "R", 1.4);
                else
                    mf.font.DrawTextVehicle(0, wheelbase + 1, mf.ABLine.howManyPathsAway.ToString() + "L", 1.4);
            }
            GL.LineWidth(1);
