...
namespace AgOpenGPS
{
    ...
    public partial class FormGPS : Form
    {
        ...
        //Steermode 0=Stanley, 1=StanleyFS
        //SteerMode 2=PurePursuit,  3=PurePursuitFS
        public int SteerMode=0; 
        //FixHeadFs true heading darf nicht mehr als 10grad abweichen oder normalbetrieb
        public bool fixHeadFs=false;
        ...
        /// Punkt Fritzklasse
        /// </summary>
        public CPunktFS cPunktFs;
        public CPunktFS cPunktFSuche;
        ...
        public FormGPS()
        {
            ...
            // Fritzpunkt
            cPunktFs = new CPunktFS(this);
            cPunktFSuche = new CPunktFS(this);
        ...
        private void FormGPS_Load(object sender, EventArgs e)
        {
            ...
            if (Settings.Default.setF_workingDirectory == "Default")
            {
                ...
                baseDirectory = (Application.StartupPath) + "\\AgOpenGPS\\";
                Settings.Default.setF_workingDirectory = (Application.StartupPath);
            }
        ...
        private void btnSteerHeadland1_Click(object sender, EventArgs e)
        {
            SteerGrenzeModus++;
            if (SteerGrenzeModus > 2) { SteerGrenzeModus = 0; }
            if (SteerGrenzeModus == 2)
            {
                btnSteerHeadland1.BackColor = Color.Tomato;
            }
            if (SteerGrenzeModus == 1)
            {
                btnSteerHeadland1.BackColor = Color.Orange;
            }
            if (SteerGrenzeModus == 0)
            {
                btnSteerHeadland1.BackColor = Color.YellowGreen;
            }

        }

        private void lblTopData_Click(object sender, EventArgs e)
        {
            if (ToolOverlapping)
            {
                ToolOverlapping = false;
            }
            else
            {
                ToolOverlapping = true;
            }
        }

        private void btnCycleLinesM_Click(object sender, EventArgs e)
        {
        ...
        private void toolStripPunktFS1_Click(object sender, EventArgs e)
        {
            Form f = Application.OpenForms["FormPunkte"];

            if (f != null)
            {
                f.Focus();
                f.Close();
                PunktFSsichtbar = false;
                Messpunkt = false;
                return;
            }

            Form form = new FormPunkte(this);
            PunktFSsichtbar = true;
            Messpunkt = false;
            form.Show();
